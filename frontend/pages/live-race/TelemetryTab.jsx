function StatTile({ label, value, unit }) {
    return (
        <div style={{ flex: 1, background: '#fff', border: '1px solid #eeece6', borderRadius: 8, padding: '14px 18px' }}>
    ...
    return (
        <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', flex: 1 }}>
            ...
            <div style={{ padding: '24px 32px' }}>
                ...
                <svg viewBox="0 0 600 110" style={{ width: '100%', height: 150, background: '#fff', border: '1px solid #eeece6', borderRadius: 8 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 16 }}>
                    <div>
                        ...
                        <svg viewBox="0 0 600 70" style={{ width: '100%', height: 90, background: '#fff', border: '1px solid #eeece6', borderRadius: 8 }}>
