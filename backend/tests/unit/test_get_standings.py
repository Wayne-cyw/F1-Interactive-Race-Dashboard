...
def test_sums_points_across_rounds_and_ranks_descending():
    round_1 = [
        DriverResult(driver="VER", driver_name="Max Verstappen", team="Red Bull Racing", position=1, points=18.0, status="Finished"),
        DriverResult(driver="HAM", driver_name="Lewis Hamilton", team="Mercedes", position=2, points=25.0, status="Finished"),
    ]
    round_2 = [
